...
class HTMLParserListener(ParseTreeListener):
    ...
    def enterHtmlAttributeName(self, ctx:HTMLParser.HtmlAttributeNameContext):
        pass

    # Exit a parse tree produced by HTMLParser#htmlAttributeName.
    def exitHtmlAttributeName(self, ctx:HTMLParser.HtmlAttributeNameContext):
        pass


    # Enter a parse tree produced by HTMLParser#htmlAttributeValue.
    def enterHtmlAttributeValue(self, ctx:HTMLParser.HtmlAttributeValueContext):
        pass

    # Exit a parse tree produced by HTMLParser#htmlAttributeValue.
    def exitHtmlAttributeValue(self, ctx:HTMLParser.HtmlAttributeValueContext):
        pass


    # Enter a parse tree produced by HTMLParser#htmlTagName.
    def enterHtmlTagName(self, ctx:HTMLParser.HtmlTagNameContext):
        pass

    # Exit a parse tree produced by HTMLParser#htmlTagName.
    def exitHtmlTagName(self, ctx:HTMLParser.HtmlTagNameContext):
        pass
    ...
    def enterXhtmlCDATA(self, ctx:HTMLParser.XhtmlCDATAContext):
        pass

    # Exit a parse tree produced by HTMLParser#xhtmlCDATA.
    def exitXhtmlCDATA(self, ctx:HTMLParser.XhtmlCDATAContext):
        pass


    # Enter a parse tree produced by HTMLParser#dtd.
    def enterDtd(self, ctx:HTMLParser.DtdContext):
        pass

    # Exit a parse tree produced by HTMLParser#dtd.
    def exitDtd(self, ctx:HTMLParser.DtdContext):
        pass


    # Enter a parse tree produced by HTMLParser#xml.
    def enterXml(self, ctx:HTMLParser.XmlContext):
        pass

    # Exit a parse tree produced by HTMLParser#xml.
    def exitXml(self, ctx:HTMLParser.XmlContext):
        pass


    # Enter a parse tree produced by HTMLParser#scriptlet.
    def enterScriptlet(self, ctx:HTMLParser.ScriptletContext):
        pass

    # Exit a parse tree produced by HTMLParser#scriptlet.
    def exitScriptlet(self, ctx:HTMLParser.ScriptletContext):
        pass
